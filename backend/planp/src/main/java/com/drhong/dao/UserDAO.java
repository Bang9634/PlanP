...
public class UserDAO {
    ...
    public boolean save(User user) {
        ...
        // 매개변수: (user_id, email, name, password, phone)
        String sql = "INSERT INTO users (user_id, email, name, password, phone) VALUES (?, ?, ?, ?, ?)";

        try (Connection conn = getConnection();
            PreparedStatement pstmt = conn.prepareStatement(sql)) {
            
            logger.debug("사용자 저장 시도: userId={}, email={}, phone={}", 
    ...
    public User findByUserId(String userId) {
        ...
        String sql = "SELECT user_id, email, name, password, phone FROM users WHERE user_id = ?";
    ...
    public User findByEmail(String email) {
        ...
        String sql = "SELECT user_id, email, name, password, phone FROM users WHERE email = ?";
    ...
    public List<User> findAll() {
        ...
        String sql = "SELECT user_id, email, name, password, phone FROM users";
